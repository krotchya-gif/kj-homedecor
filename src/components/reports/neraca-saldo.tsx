...
export default function NeracaSaldoPage({ variant = 'finance' }: { variant?: 'finance' | 'owner' } = {}) {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Neraca Saldo"
        subtitle={`Daftar aktivitas akun dalam format debit-kredit${isOwner ? ' - Tampilan Owner (Read Only)' : ''}`}
