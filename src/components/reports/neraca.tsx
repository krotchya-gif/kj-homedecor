...
export default function NeracaPage({ variant = 'finance' }: { variant?: 'finance' | 'owner' } = {}) {
  ...
  return (
    <div>
      ...
      <PageHeader
        ...
        subtitle={`Laporan posisi keuangan (Aset, Liabilitas, Ekuitas)${isOwner ? ' - Tampilan Owner (Read Only)' : ''}`}
