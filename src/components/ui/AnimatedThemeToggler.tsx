...
// Semua koordinat persentase dari snapshot reference box (Chrome 150 fix,
// lihat https://github.com/magicuidesign/magicui#989).
...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    // Aksesibilitas: tanpa animasi kalau user minta reduced motion
