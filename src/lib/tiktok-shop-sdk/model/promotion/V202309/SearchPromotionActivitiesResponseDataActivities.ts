...
import { Promotion202309SearchPromotionActivitiesResponseDataActivitiesDiscount } from './SearchPromotionActivitiesResponseDataActivitiesDiscount';
import { Promotion202309SearchPromotionActivitiesResponseDataActivitiesParticipationLimit } from './SearchPromotionActivitiesResponseDataActivitiesParticipationLimit';

export class Promotion202309SearchPromotionActivitiesResponseDataActivities {
    /**
    * Applicable commands to the activity:  - IMMUTABLE: The activity cannot be edited or deactivated.
    */
    'activityCommands'?: Array<string>;
    /**
    * The type of activities. Possible values: - `FIXED_PRICE`: product discount activity with fixed price. - `DIRECT_DISCOUNT`: product discount activities with percentage off. - `FLASHSALE`: flash sale activity. - `SHIPPING_DISCOUNT`: shipping fee discount.
    */
    'activityType'?: string;
    /**
    ...
    */
    'createTime'?: number;
    'discount'?: Promotion202309SearchPromotionActivitiesResponseDataActivitiesDiscount;
    /**
    ...
    */
    'participationLimit'?: Array<Promotion202309SearchPromotionActivitiesResponseDataActivitiesParticipationLimit>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "discount",
            "baseName": "discount",
            "type": "Promotion202309SearchPromotionActivitiesResponseDataActivitiesDiscount"
        },
        {
            "name": "durationType",
        ...
        },
        {
            ...
            "type": "Array<Promotion202309SearchPromotionActivitiesResponseDataActivitiesParticipationLimit>"
        },
        {
            "name": "productLevel",
    ...
    static getAttributeTypeMap() {
        return Promotion202309SearchPromotionActivitiesResponseDataActivities.attributeTypeMap;
    }
}
