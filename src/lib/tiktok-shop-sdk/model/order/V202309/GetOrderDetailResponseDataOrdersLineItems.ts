...
import { Order202309GetOrderDetailResponseDataOrdersLineItemsUnboxingCaseList } from './GetOrderDetailResponseDataOrdersLineItemsUnboxingCaseList';
...
export class Order202309GetOrderDetailResponseDataOrdersLineItems {
    ...
    */
    'isGift'?: boolean;
    /**
    * Identifies if this SKU contains print on demand customization
    */
    ...
    */
    ...
    /**
    * ID of the print on demand customization details. This ID can be used to query for the exact details of the customization
    */
    'podInfoId'?: string;
    /**
    * Product ID.
    ...
    */
    ...
    /**
    * The unique ID of the LIVE session where the order line item was created. If the order line item was not created from a LIVE session, this field returns an empty string.
    */
    'roomId'?: string;
    /**
    ...
    */
    ...
    /**
    * Shipping vat amount Available in EU market
    */
    'shippingVatAmount'?: string;
    /**
    * Shipping vat rate Available in EU market
    */
    ...
    */
    ...
    /**
    * A seller\'s third party sku code for the case unboxed item, which warehouse fulfillment operations can reference to identify the accurate product they are shipping.  Note: This is currently only available in the US market. 
    */
    'unboxingCaseList'?: Array<Order202309GetOrderDetailResponseDataOrdersLineItemsUnboxingCaseList>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "isPodCustomized",
            "baseName": "is_pod_customized",
            "type": "boolean"
        },
        {
            "name": "isUnboxingItem",
        ...
        },
        {
            ...
            "baseName": "shipping_vat_amount",
            "type": "string"
        },
        {
            "name": "shippingVatRate",
            "baseName": "shipping_vat_rate",
            "type": "string"
        },
        {
            "name": "skuId",
        ...
        {
            "name": "unboxingCaseList",
            "baseName": "unboxing_case_list",
            "type": "Array<Order202309GetOrderDetailResponseDataOrdersLineItemsUnboxingCaseList>"
        },
        {
