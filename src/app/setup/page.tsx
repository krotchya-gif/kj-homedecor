      ...
      >
        ...
        {result?.error ? (
          ...
          <div>
            ...
            >
              <div style={{ fontWeight: '700', color: '#065f46', marginBottom: '0.75rem', fontSize: '0.95rem' }}>
            ...
            >
              ⚠️ <strong>Ganti password ini setelah login!</strong>
              <br />
          ...
          <div>
            ...
            >
              <div style={{ fontSize: '0.82rem', color: 'var(--neutral-600)', lineHeight: 1.6 }}>
                ...
                <br />
                3. Login menggunakan kredensial yang muncul
                <br />
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                    <input
                      type="email"
                      placeholder="Email"
                      value={form[`${r.key}_email` as keyof typeof form]}
                      onChange={(e) => setForm((f) => ({ ...f, [`${r.key}_email`]: e.target.value }))}
                      style={{
                        padding: '0.5rem',
                    ...
                    <input
                      ...
                      value={form[`${r.key}_password` as keyof typeof form]}
                      onChange={(e) => setForm((f) => ({ ...f, [`${r.key}_password`]: e.target.value }))}
                      style={{
                        padding: '0.5rem',
                        border: '1px solid #d1d5db',
                        borderRadius: '0.375rem',
                    ...
                    <input
                      ...
                      value={form[`${r.key}_name` as keyof typeof form]}
                      onChange={(e) => setForm((f) => ({ ...f, [`${r.key}_name`]: e.target.value }))}
                      style={{
                        padding: '0.5rem',
                        border: '1px solid #d1d5db',
                        borderRadius: '0.375rem',
