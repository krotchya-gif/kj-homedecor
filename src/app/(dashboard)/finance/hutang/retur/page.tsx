              ...
              {filtered.map((r) => {
                ...
                return (
                  <tr key={r.id}>
                    ...
                    <td style={{ color: '#6b7280', maxWidth: 200, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{r.return_reason ?? '—'}</td>
                    <td style={{ color: '#6b7280' }}>{r.return_date ? new Date(r.return_date).toLocaleDateString('id-ID') : '—'}</td>
                    <td>
