	...
	async function fetchData() {
		...
		const [cashRes, revRes, journalRes] = await Promise.all([
			...
			supabase
				...
				.select(
					"*, lines:journal_lines(*), cash_account:cash_accounts!inner(account_id, bank_name, account_number)",
				)
		...
		<div>
			<div className="page-header">
				...
				<p className="page-subtitle">
					Catat pemasukan non-order (jual aset, refund, dll)
				</p>
			</div>
								...
								return (
									<tr key={j.id}>
										<td style={{ color: "#6b7280" }}>
											{new Date(j.entry_date).toLocaleDateString("id-ID")}
										</td>
