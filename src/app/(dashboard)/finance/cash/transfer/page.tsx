		...
		<div>
			<div className="page-header">
				...
				<p className="page-subtitle">
					Pemindahan saldo antar akun kas/bank/e-wallet
				</p>
			</div>
						...
						>
							...
							<div>
								...
								<select
									...
									onChange={(e) =>
										setForm((f) => ({ ...f, to_account_id: e.target.value }))
									}
									style={{
										width: "100%",
										padding: "0.625rem",
							...
							>
								...
								<button
									type="submit"
									disabled={
										saving || form.from_account_id === form.to_account_id
									}
									style={{
										flex: 1,
										padding: "0.75rem",
