...
export default async function LandingPage() {
	...
	const heroTitle =
		settings?.hero_title ?? "Percantik Ruanganmu dengan Gorden Premium";
	const heroSubtitle =
	...
	const whatsappMessage =
		...
		"Halo KJ Homedecor, saya ingin konsultasi gorden";
	...
	return (
      ...
      `}</style>
			...
			<div
				style={{ background: themeBackground, fontFamily: "Inter, sans-serif" }}
			>
				{/* ===== NAVBAR ===== */}
				<ScrollNav
				...
				<section
					id="products"
					style={{ padding: "6rem 0", background: themeBackground }}
				>
					<div className="landing-section" style={{ padding: "0 1.5rem" }}>
						<div style={{ textAlign: "center", marginBottom: "3rem" }}>
							...
							<h2
								className="landing-section-title"
								style={{ margin: "0 auto 0.75rem", color: themeText }}
							>
								Produk Pilihan
							</h2>
							<p
							...
							>
								Pilihan gorden, vitras, roman blind, dan aksesoris berkualitas
								tinggi
							</p>
						</div>
				...
				>
					<div
						...
						style={{ padding: "0 1.5rem", textAlign: "center" }}
					>
						<div
							className="landing-section-label"
						...
						>
							{settings?.whyus_title ?? "Dipercaya"}{" "}
							<AnimatedCounter target={500} suffix="+" /> Pelanggan
						</h2>
						...
						>
							{[
								...
								},
								{
									...
									desc:
										settings?.whyus_card2_desc ??
										"Telah melayani ratusan pelanggan puas di seluruh Jabodetabek",
									color: themePrimary,
								},
								{
									icon: <Truck size={34} />,
									...
									desc:
										settings?.whyus_card3_desc ??
										"Tim installer bersertifikat siap membantu langsung ke rumah Anda",
								...
								},
								{
									...
									desc:
										settings?.whyus_card4_desc ??
										"Garansi kualitas penuh untuk setiap produk yang kami hasilkan",
									color: themeAccent,
								},
							].map((f, i) => (
										...
										<div key={title} className="portfolio-card">
											<div className="portfolio-card-img-wrap">
												...
												>
													<Sparkles
														size={44}
														style={{ color: colors[i], opacity: 0.7 }}
													/>
												</div>
								...
								{portfolio.map((post) => (
									<div key={post.id} className="portfolio-card">
											...
											>
												{(post.images as string[])?.[0] ? (
													...
													>
														<Sparkles
															size={44}
															style={{ color: themePrimary, opacity: 0.5 }}
														/>
													</div>
												)}
											</div>
										...
										<div style={{ padding: "1.25rem" }}>
											...
											<p
												className="landing-card-desc"
												style={{ fontSize: "0.85rem", color: `${themeText}99` }}
											>
					...
					<div style={{ maxWidth: 1200, margin: "0 auto" }}>
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 mb-12 footer-grid">
							...
							<div>
								...
								>
									Spesialis gorden, curtain, roman blind, dan vitras premium.
									Pemasangan profesional ke seluruh Jabodetabek.
								</p>
								{/* Social media icons */}
								<div
								...
								>
									...
									{shopee && (
										<a
											href={
												shopee.startsWith("http")
													? shopee
													: `https://shopee.co.id/${shopee}`
											}
											target="_blank"
											rel="noopener noreferrer"
											className="footer-social"
									...
									{tokopedia && (
										<a
											href={
												tokopedia.startsWith("http")
													? tokopedia
													: `https://tokopedia.com/${tokopedia}`
											}
											target="_blank"
											rel="noopener noreferrer"
											className="footer-social"
							...
							<div>
								...
								>
									...
									>
										<Phone
											size={15}
											style={{ color: themeAccent, flexShrink: 0 }}
										/>
										<a
