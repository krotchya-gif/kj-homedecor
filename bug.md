...
| BUG-112 | **Monolit `admin/orders/[id]` — section render besar inline** (pipeline stepper ~110 baris, Hasil Survey + modal pilih ~90 baris) | ✅ Fixed (Phase 6B-3, 2026-08-13) | Ekstrak `OrderPipelineStepper` (props statuses/statusIdx/photos/onPhotoClick) & `OrderSurveySection` (survey + modal link). Page turun 2.923 → 2.749 baris. Behavior-preserving. Alasan (SOP #4): section modular |
