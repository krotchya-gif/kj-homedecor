...
CREATE TABLE IF NOT EXISTS public.landing_settings (
  ...
  cta_title TEXT,
  cta_subtitle TEXT,
  theme_primary_color TEXT DEFAULT '#F6C8CC',
  theme_secondary_color TEXT DEFAULT '#CAB6B1',
  theme_accent_color TEXT DEFAULT '#E7486A',
  theme_background_color TEXT DEFAULT '#EDEFF0',
  theme_text_color TEXT DEFAULT '#595F61',
  theme_preset TEXT DEFAULT 'default' CHECK (theme_preset IN ('default','modern','gold','green','purple','custom','tenang','lembut','sejuk','gelap-netral','earthy','bold','rose-premium','dark')),
